...
successfully completing the disambiguation. This is done by determining the percentage each word 
in the sentence has appeared with the target, multiplied by the number of correct disambiguations 
the word has been apart of. After the best words are selected, they are loaded 
...
\begin{enumerate}
	...
	are loaded.  The word would be added through the memory object after the completion of the problem.  
