...
``I enjoy bass, it tastes delicious!", an example of a stopword is ``it", and ``I". The
remaining words would be transformed to lowercase and passed to stemmer. The output would
