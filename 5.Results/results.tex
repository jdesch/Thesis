...
\begin{table}[htp]
	\begin{tabular}{|l|l|l|l|l|}
		...
		{\bf $r^2$}   &   {\bf adjusted $r^2$}     &    {\bf F-value }    &   {\bf MSE} & {\bf AIC} \\ \hline
		0.0882      &      0.072        &   5.42 (p = 0.0235)      &    $4.57*10^{-4}$ & -278 \\ \hline
		\end{tabular}
...
\begin{table}[htp]
	\begin{tabular}{|l|l|l|l|l|}
		...
		{\bf $r^2$}   &   {\bf adjusted $r^2$}     &    {\bf F-value }    &   {\bf MSE} & {\bf AIC} \\ \hline
		0.24      &      0.2        &   6 (p = 0.0242)      &    $5.33*10^{-4}$ & -95 \\ \hline
		\end{tabular}
...
\begin{table}[htp]
	\begin{tabular}{|l|l|l|l|l|l|}
		...
		{\bf acc.} & {\bf statistic acc.} & {\bf excl. stat.}& {\bf connective acc. } & {\bf excl. acc. } & {\bf optimal acc.} \\ \hline
