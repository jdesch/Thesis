...
\begin{figure}[htp]
	\begin{center}
		...
		\caption{regression analysis of training accuracy over one fold (x Instances, y Accuracy)}
	\end{center}
	\label{fig:ONEFOLDACCURACY}
\end{figure}
...
\begin{table}[htp]
	\begin{tabular}{|l|l|l|l|l|}
		...
		\end{tabular}
		\caption{statistical values of regression analysis over one fold}
		\label{table:STATFOLD}       
\end{table}
...
\begin{table}[htp]
	...
	\end{tabular}
	\caption{various accuracy comparisons between components}
	\label{table:ALLACCURACY}
\end{table}
